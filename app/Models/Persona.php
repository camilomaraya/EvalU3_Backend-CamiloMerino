...
class Persona extends Model
{
    ...
    protected $fillable = [
        'email', 'telefono', 'comprobante_residencia', 'codigo_talento',
        'resumen', 'nivel_educacional', 'titulo_carrera', 'anio_egreso',
        'anios_experiencia', 'areas_experiencia', 'competencias',
        'rango_renta', 'tipo_jornada', 'modalidad',
    ...
    public function contactosSolicitados(): HasMany
    {
